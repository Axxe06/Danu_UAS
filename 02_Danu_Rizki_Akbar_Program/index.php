...
<head>
    ...
    <title>Open Trip With Danu</title>
...
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-light fw-bold" style="background-color:#2dd4bf; position: sticky; top: 0; z-index: 1000;" >
        <div class="container">
            <a class="navbar-brand" href="#">Open<span style="color:#eab308;"><b>Trip</b></span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="navMountain" onclick="MountainPage()">Mountain</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="navOpentrip" onclick="UserPage()">OpenTrip</a>
                    </li>
                    <li class="nav-item">
                ...
                <span class="navbar-text d-flex align-items-center">
                    ...
                    <?= $_SESSION['nama']; ?>
                        ...
                        <i class="bi bi-box-arrow-in-right fw-bold ms-4" style="font-size:1.5rem;" href="#"  id="navLogout" onclick="logout()"></i>
